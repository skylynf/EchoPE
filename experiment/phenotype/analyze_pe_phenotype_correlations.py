...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument(
        "--predictions",
        type=Path,
        default=Path("experiments/experiment/phenotype/results/pe_phenotype_predictions.csv"),
    ...
    ap.add_argument(
        "--output-dir",
        type=Path,
        default=Path("experiments/experiment/phenotype/results/analysis"),
...
def main() -> None:
    args = parse_args()
    echo_root = Path(__file__).resolve().parents[3]
    ...
    print("ready_for_plot=EchoPrime/experiments/experiment/phenotype/plot_pe_phenotype_figure.py")
